 ...
 * @return array
 */
function memberlite_elements_get_font_awesome_icons( $type = NULL ) {
	if ( $type === 'brand' ) {
		...
		$font_awesome_icons_array = array_unique( array_merge( memberlite_elements_get_font_awesome_icons( 'brand' ), memberlite_elements_get_font_awesome_icons( 'regular' ), memberlite_elements_get_font_awesome_icons( 'solid' ) ) );
