 ...
 */
function memberlite_elements_subpagelist_shortcode_handler( $atts, $content = null, $code = '' ) {
	global $post;
...
add_shortcode( 'memberlite_subpagelist', 'memberlite_elements_subpagelist_shortcode_handler' );
 ...
 */
function memberlite_elements_remove_subpagelist_from_excerpt( $excerpt ) {
	$excerpt = preg_replace( '/\[subpagelist[^\]]*\]/', '', $excerpt );
	return $excerpt;
}
add_filter( 'the_excerpt', 'memberlite_elements_remove_subpagelist_from_excerpt' );
