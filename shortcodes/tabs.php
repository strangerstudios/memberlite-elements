...
function memberlite_elements_tabs_shortcode($atts, $content = null) {
...
add_shortcode('memberlite_tabs', 'memberlite_elements_tabs_shortcode');

function memberlite_elements_tab_shortcode($atts, $content = null) {
	// $atts    ::= array of attributes
	// $content ::= text within enclosing form of shortcode element
...
add_shortcode('memberlite_tab', 'memberlite_elements_tab_shortcode');